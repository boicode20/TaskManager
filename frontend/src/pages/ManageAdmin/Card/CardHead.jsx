...
const CardHead = ({admin}) => {
  return (
     <div className="card-header grid grid-cols-[100px_1fr] place-items-center">
            <div className="card-header-image">
                <img src={admin.avatar} alt="Admin Avatar" className="w-16 h-16 rounded-full mx-auto" />
            </div>
            <div className="card-name-email w-full flex flex-col">
                <h3 className="text-lg font-semibold text-[#4c4b4b]">{admin.name}</h3>
